...
- The prior coarse `unresolved_call_args_` escape hatch and direct-call compatibility-reason table have both been removed; sema now relies on resolved-target ownership plus unresolved-path invariants/counters instead of reason-coded bookkeeping.
