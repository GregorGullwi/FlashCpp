...
See also: [LEXER_OPTIMIZATION_PROPOSAL.md](LEXER_OPTIMIZATION_PROPOSAL.md) for
dispatch table and SIMD scanning optimizations that complement this
refactoring.
