...
**Date:** 2026-04-08  
**Last Updated:** 2026-04-21 (Phase 5 Slice K: all 4 residual codegen callers of `ensureMemberFunctionMaterialized` audited dead and removed; codegen no longer calls sema's materialization API)
