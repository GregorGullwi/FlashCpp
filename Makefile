...
TEST_SOURCES := $(SRCDIR)/AstNodeTypes.cpp $(SRCDIR)/ChunkedAnyVector.cpp $(SRCDIR)/Parser.cpp $(SRCDIR)/CodeViewDebug.cpp $(SRCDIR)/ExpressionSubstitutor.cpp $(SRCDIR)/TemplateInstantiator.cpp

# Main sources (excluding LLVM-dependent files)
MAIN_SOURCES := $(SRCDIR)/AstNodeTypes.cpp $(SRCDIR)/ChunkedAnyVector.cpp $(SRCDIR)/Parser.cpp $(SRCDIR)/CodeViewDebug.cpp $(SRCDIR)/ExpressionSubstitutor.cpp $(SRCDIR)/TemplateInstantiator.cpp $(SRCDIR)/main.cpp
