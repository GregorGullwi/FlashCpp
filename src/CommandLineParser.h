...
inline constexpr CliOptionInfo all_cli_flags[] = {
	...
	{"perf-stats", "", "Show performance statistics (type table, IR; parser phases require WITH_PARSER_RUNTIME_STATS=1)", "", false},
	{"stats", "", "Show performance statistics", "", true},
	{"alloc-stats", "", "Track global operator new/delete allocations (FLASHCPP_TRACK_ALLOCATIONS=1; call-site stacks: FLASHCPP_TRACK_ALLOCATION_STACKS=1)", "", false},
	{"mem-stats", "", "Alias for --alloc-stats", "", true},
