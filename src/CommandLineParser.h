...
inline constexpr CliOptionInfo all_cli_flags[] = {
	...
	{"perf-stats", "", "Show compiler performance statistics (type table, parser phases, IR)", "", false},
	{"stats", "", "Show performance statistics", "", true},
	{"alloc-stats", "", "Track and report global operator new/delete allocations (requires FLASHCPP_TRACK_ALLOCATIONS=1 build)", "", false},
