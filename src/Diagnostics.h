...
enum class DiagnosticId : uint32_t {
	...
	AliasMultidimensionalParameterUnsupported = 1818,

	// Parser syntax family (1901..1999).
	UnexpectedToken = 1901,
	MissingSemicolon = 1902,
	UnexpectedEndOfFile = 1903,
};
...
inline std::string_view diagnosticIdName(DiagnosticId id) {
	...
	case DiagnosticId::DefaultedFunctionNotSpecialMember:
		return "DefaultedFunctionNotSpecialMember";
	case DiagnosticId::DeletedDefinitionNotFirstDeclaration:
	...
	case DiagnosticId::ImmediateInvocationNotConstant:
		return "ImmediateInvocationNotConstant";
	case DiagnosticId::DeletedCopyConstructor:
	...
	case DiagnosticId::AliasTemplateSpecializationForbidden:
	...
	case DiagnosticId::AliasMultidimensionalParameterUnsupported:
		return "AliasMultidimensionalParameterUnsupported";
	case DiagnosticId::UnexpectedToken:
		return "UnexpectedToken";
	case DiagnosticId::MissingSemicolon:
		return "MissingSemicolon";
	case DiagnosticId::UnexpectedEndOfFile:
