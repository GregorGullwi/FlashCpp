...
private:
	...
	TemplateVector<StructCodegenFrame, 8> struct_codegen_frame_stack_;
	TemplateVector<ActiveSwitchContext, 4> active_switch_context_stack_;
	...
	bool isSameStructTypeForInitialization(TypeIndex lhs_type_index, TypeIndex rhs_type_index) const;
