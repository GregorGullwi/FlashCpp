...
// Use __COUNTER__ to generate unique variable names to avoid shadow warnings
#define PROFILE_TEMPLATE_CONCAT_IMPL(x, y) x##y
#define PROFILE_TEMPLATE_CONCAT(x, y) PROFILE_TEMPLATE_CONCAT_IMPL(x, y)
