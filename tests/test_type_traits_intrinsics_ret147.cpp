...
int test_is_class() {
	...
	if (__is_class(MyStruct))
		result += 1;
	if (__is_class(MyClass))
		result += 2;
...
int test_is_enum() {
	...
	if (__is_enum(Color))
		result += 1;
	if (__is_enum(ScopedColor))
		result += 2;

	// These should be false
	if (!__is_enum(int))
		result += 4;
	if (!__is_enum(MyStruct))
		result += 8;
...
int test_is_union() {
	...
	if (!__is_union(int))
		result += 1;
	if (!__is_union(MyStruct))
		result += 2;
	if (!__is_union(MyClass))
		result += 4;
...
int test_is_base_of() {
	...
	if (!__is_base_of(MyStruct, MyClass))
		result += 1;
	// Same type should return true
	if (__is_base_of(MyStruct, MyStruct))
		result += 2;
	if (__is_base_of(MyClass, MyClass))
		result += 4;
...
int test_is_polymorphic() {
	...
	if (!__is_polymorphic(MyStruct))
		result += 1;
	if (!__is_polymorphic(MyClass))
		result += 2;
...
int test_is_abstract() {
	...
	if (!__is_abstract(MyStruct))
		result += 1;
	if (!__is_abstract(MyClass))
		result += 2;
...
int test_is_final() {
	int result = 0;
	// Non-final classes
	if (!__is_final(MyStruct))
		result += 1;
	if (!__is_final(MyClass))
		result += 2;
...
int test_is_empty() {
	...
	if (!__is_empty(MyStruct))
		result += 1;
	if (!__is_empty(MyClass))
		result += 2;
...
int test_is_standard_layout() {
	...
	if (__is_standard_layout(int))
		result += 1;
	if (__is_standard_layout(double))
		result += 2;
	// Simple structs are standard layout
	if (__is_standard_layout(MyStruct))
		result += 4;
...
int test_is_trivially_copyable() {
	...
	if (__is_trivially_copyable(int))
		result += 1;
	if (__is_trivially_copyable(double))
		result += 2;
...
int test_has_unique_object_representations() {
	...
	if (__has_unique_object_representations(int))
		result += 1;
	if (__has_unique_object_representations(char))
		result += 2;
	if (__has_unique_object_representations(long))
		result += 4;
...
int test_is_constructible() {
	...
	if (__is_constructible(int))
		result += 1;
	if (__is_constructible(double))
		result += 2;
	// Scalars are copy constructible
	if (__is_constructible(int, int))
		result += 4;
...
int test_is_destructible() {
	...
	if (__is_destructible(int))
		result += 1;
	if (__is_destructible(double))
		result += 2;
	// Trivially destructible scalars
	if (__is_trivially_destructible(int))
		result += 4;
...
int test_is_layout_compatible() {
	...
	if (__is_layout_compatible(int, int))
		result += 1;
	if (__is_layout_compatible(double, double))
		result += 2;
