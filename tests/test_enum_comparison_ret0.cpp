...
enum class Status { Pending = 1, Running = 2, Done = 3 };
...
int test_enum_equality() {
    ...
    int result = 0;
    if (a == b) result += 1;  // true
    if (a != c) result += 2;  // true
    if (a == c) result += 4;  // false, shouldn't add
...
int test_enum_inequality() {
    ...
    int result = 0;
    if (a != b) result += 1;
    if (a != a) result += 2;  // should be false
...
int test_enum_less_than() {
    ...
    int result = 0;
    if (a < b) result += 1;   // 1 < 2, true
    if (b < c) result += 2;   // 2 < 3, true
    if (c < a) result += 4;   // 3 < 1, false
...
int test_enum_greater_than() {
    ...
    int result = 0;
    if (c > b) result += 1;   // 3 > 2, true
    if (b > a) result += 2;   // 2 > 1, true
    if (a > c) result += 4;   // 1 > 3, false
...
int test_enum_less_equal() {
    ...
    int result = 0;
    if (a <= b) result += 1;  // 1 <= 1, true
    if (a <= c) result += 2;  // 1 <= 2, true
    if (c <= a) result += 4;  // 2 <= 1, false
...
int test_enum_greater_equal() {
    ...
    int result = 0;
    if (b >= a) result += 1;  // 1 >= 1, true
    if (c >= a) result += 2;  // 2 >= 1, true
    if (a >= c) result += 4;  // 1 >= 2, false
...
int test_enum_class_comparison() {
    ...
    int result = 0;
    if (s1 != s2) result += 1;
    if (static_cast<int>(s1) < static_cast<int>(s2)) result += 2;
...
int test_enum_vs_int_comparison() {
    ...
    int result = 0;
    if (c == 2) result += 1;   // 2 == 2, true
    if (c < 3) result += 2;    // 2 < 3, true
    if (c > 1) result += 4;    // 2 > 1, true
    if (c != 5) result += 8;   // 2 != 5, true
