...
enum SmallEnum : short { A = 1, B = 2, C = 3 };
enum BigEnum : long long { X = 100000000LL, Y = 200000000LL };
enum UnsignedEnum : unsigned int { U1 = 0, U2 = 4000000000U };
