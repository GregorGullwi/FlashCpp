...
int main() {
	...
	if (offset1_c != 0)
		return 2;
	if (offset1_i != 1)
		return 3;  // No padding with pack(1)
	if (offset1_s != 5)
		return 4;
	...
	if (offset2_c != 0)
		return 6;
	if (offset2_i != 2)
		return 7;  // Aligned to 2 with pack(2)
	if (offset2_s != 6)
		return 8;
	...
	if (offset_default_c != 0)
		return 10;
	if (offset_default_i != 4)
		return 11;  // Aligned to 4 by default
	if (offset_default_s != 8)
		return 12;
