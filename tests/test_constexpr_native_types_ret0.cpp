...
static_assert(cv_bool == true);
constexpr char cv_char = 'A';
static_assert(cv_char == 65);
constexpr signed char cv_schar = -5;
static_assert(cv_schar == -5);
constexpr unsigned char cv_uchar = 200;
static_assert(cv_uchar == 200);
constexpr short cv_short = 1000;
static_assert(cv_short == 1000);
constexpr unsigned short cv_ushort = 60000;
static_assert(cv_ushort == 60000);
constexpr int cv_int = -42;
static_assert(cv_int == -42);
constexpr unsigned int cv_uint = 4000000000u;
static_assert(cv_uint == 4000000000u);
constexpr long cv_long = 100000L;
static_assert(cv_long == 100000L);
constexpr unsigned long cv_ulong = 3000000000UL;
static_assert(cv_ulong == 3000000000UL);
constexpr long long cv_llong = -9000000000LL;
static_assert(cv_llong == -9000000000LL);
constexpr unsigned long long cv_ullong = 10000000000ULL;
static_assert(cv_ullong == 10000000000ULL);
constexpr float cv_float = 3.14f;
static_assert(cv_float == 3.14f);
constexpr double cv_double = 2.718281828;
static_assert(cv_double == 2.718281828);
constexpr long double cv_ldouble = 1.41421356L;
static_assert(cv_ldouble == 1.41421356L);

// --- Arithmetic (same-type) ---
constexpr double da = 3.14 + 2.0;
static_assert(da > 5.0);
constexpr float fa = 3.14f + 2.0f;
static_assert(fa > 5.0f);
constexpr unsigned int ua = 100u + 200u;
static_assert(ua == 300u);
constexpr long long la = 1000000LL * 1000000LL;
static_assert(la == 1000000000000LL);
