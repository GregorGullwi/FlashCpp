...
| `<tuple>` | `test_std_tuple.cpp` | ❌ Codegen Error | 5.20s wall (retested 2026-08-11, Windows/MSVC STL 14.44). Dependent `three_way_comparable_with` remains non-constant, followed by an ambiguous constructor and unmaterialized deferred function. |
